...
class TangBotController:
    ...
    def __init__(self):
        ...
        #     self.usb.write_timeout = 0.1  # TEST THIS
        self.running = True
        ...
        self.writeCmd(BotServos.RightWheel.value, self.TARGET_CENTER)
        self.writeCmd(BotServos.LeftWheel.value, self.TARGET_CENTER)
